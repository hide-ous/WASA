...
function extractCourseDetails() {
    ...
    courseRows.forEach((row, index) => {
        ...
        const year = cells[1] ? cells[1].textContent.trim() : 'N/D';
        const semester = cells[2] ? cells[2].textContent.trim() : 'N/D';
        // Converti CFU in numero, se possibile
        const cfuText = cells[3] ? cells[3].textContent.trim() : '0';
        const cfu = parseInt(cfuText, 10);
